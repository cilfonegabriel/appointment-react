...
**Appointment React App** is a web application built with React. The app allows users to manage a list of patients, including adding new patients, updating their information, and deleting patients. Provides a simple user interface to interact with employee data and perform CRUD (Create, Read, Update, Delete) operations.

<!-- LIVE DEMO -->

## 🚀 Live Demo <a name="live-demo"></a>

- [Live Demo](https://65007ad8306f490087638b46--earnest-unicorn-443f33.netlify.app/)
...
```sh
git https://github.com/cilfonegabriel/appointment-react.git
...
Feel free to check the [issues page](https://github.com/cilfonegabriel/appointment-react/issues).
